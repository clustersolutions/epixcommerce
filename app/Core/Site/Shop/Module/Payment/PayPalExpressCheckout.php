 ...
 */
  ...
  namespace OSC\Core\Site\Shop\Module\Payment;

  use OSC\Core\HttpRequest;
  use OSC\Core\Mail;
  use OSC\Core\OSCOM;
  use OSC\Core\Registry;
  use OSC\Core\Site\Shop\Order;
  use OSC\Core\Site\Shop\Shipping;

  class PayPalExpressCheckout extends \OSC\Core\Site\Shop\PaymentModuleAbstract {
