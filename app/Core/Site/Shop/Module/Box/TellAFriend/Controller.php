 ...
 */
  ...
  namespace OSC\Core\Site\Shop\Module\Box\TellAFriend;
  ...
  class Controller extends \OSC\Core\Modules {
    ...
    public function initialize() {
      ...
      if ( isset($OSCOM_Product) && ($OSCOM_Product instanceof \OSC\Site\Shop\Product) && $OSCOM_Product->isValid() ) { // HPDL && ($osC_Template->getModule() != 'tell_a_friend')) {
