 ...
 */
  ...
  class ProductVariants {
    static public function parse($module, $data) {
      if ( class_exists('OSC\\Core\\Site\\Shop\\Module\\ProductVariant\\' . $module) ) {
        return call_user_func(array('OSC\\Core\\Site\\Shop\\Module\\ProductVariant\\' . $module, 'parse'), $data);
      }
    }

    static public function getGroupTitle($module, $data) {
      if ( class_exists('OSC\\Core\\Site\\Shop\\Module\\ProductVariant\\' . $module) ) {
        return call_user_func(array('OSC\\Core\\Site\\Shop\\Module\\ProductVariant\\' . $module, 'getGroupTitle'), $data);
      }
    ...
    static public function getValueTitle($module, $data) {
      if ( class_exists('OSC\\Core\\Site\\Shop\\Module\\ProductVariant\\' . $module) ) {
        return call_user_func(array('OSC\\Core\\Site\\Shop\\Module\\ProductVariant\\' . $module, 'getValueTitle'), $data);
      }
    ...
    static public function allowsMultipleValues($module) {
      if ( class_exists('OSC\\Core\\Site\\Shop\\Module\\ProductVariant\\' . $module) ) {
        return call_user_func(array('OSC\\Core\\Site\\Shop\\Module\\ProductVariant\\' . $module, 'allowsMultipleValues'));
      }
    ...
    static public function hasCustomValue($module) {
      if ( class_exists('OSC\\Core\\Site\\Shop\\Module\\ProductVariant\\' . $module) ) {
        return call_user_func(array('OSC\\Core\\Site\\Shop\\Module\\ProductVariant\\' . $module, 'hasCustomValue'));
      }
