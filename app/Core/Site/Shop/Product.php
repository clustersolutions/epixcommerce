 ...
 */
  ...
  use OSC\Core\Site\Shop\Products;
      ...
      if ( isset($this->_data['type_assignments'][$action_call]) ) {
        foreach ( $this->_data['type_assignments'][$action_call] as $module ) {
          ...
          if ( is_null($module_call) || ($module_call == $module) ) {
            if ( class_exists('OSC\\Core\\Site\\Shop\\Module\\ProductType\\' . $module) ) {
              if ( !call_user_func(array('OSC\\Core\\Site\\Shop\\Module\\ProductType\\' . $module, 'isValid'), $this) ) {
                if ( ($execute_onfail === true) && method_exists('OSC\\Core\\Site\\Shop\\Module\\ProductType\\' . $module, 'onFail') ) {
                  call_user_func(array('OSC\\Core\\Site\\Shop\\Module\\ProductType\\' . $module, 'onFail'), $this);
                }
