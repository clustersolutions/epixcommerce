 ...
 */
  ...
  use OSC\Core\Site\Setup\Language;
...
// HPDL                   'banner',
      ...
      foreach ( $services as $service ) {
        $class = 'OSC\\Core\\Site\\Admin\\Module\\Service\\' . $service;
        $module = new $class();
        $module->install();
...
// Import Payment modules
      ...
      $module = new \OSC\Core\Site\Admin\Module\Payment\COD();
      $module->install();
...
// Import Shipping modules
      ...
      $module = new \OSC\Core\Site\Admin\Module\Shipping\Flat();
      $module->install();

// Import Order Total modules

      $module = new \OSC\Core\Site\Admin\Module\OrderTotal\SubTotal();
      $module->install();

      $module = new \OSC\Core\Site\Admin\Module\OrderTotal\Shipping();
      $module->install();

      $module = new \OSC\Core\Site\Admin\Module\OrderTotal\Tax();
      $module->install();

      $module = new \OSC\Core\Site\Admin\Module\OrderTotal\Total();
      $module->install();
