 ...
 */
  ...
  class Template extends \OSC\Core\Template {
    ...
    public function getTemplateFile($file = null, $template = null) {
      ...
      if ( !isset($file) ) {
        ...
        $file = call_user_func(array('OSC\\Core\\Site\\' . OSCOM::getSite() . '\\Template\\' . $template . '\\Controller', 'getBaseFilename'));
      }
      ...
      if ( call_user_func(array('OSC\\Core\\Site\\' . OSCOM::getSite() . '\\Template\\' . $template . '\\Controller', 'hasParent')) ) {
        $template = call_user_func(array('OSC\\Core\\Site\\' . OSCOM::getSite() . '\\Template\\' . $template . '\\Controller', 'getParent'));
    ...
    public function getPageContentsFile($file = null, $template = null, $application = null, $site = null) {
      ...
      if ( call_user_func(array('OSC\\Core\\Site\\' . $site . '\\Template\\' . $template . '\\Controller', 'hasParent')) ) {
        while ( true ) {
          $template = call_user_func(array('OSC\\Core\\Site\\' . $site . '\\Template\\' . $template . '\\Controller', 'getParent'));
