 ...
 */
  ...
  define('OSCOM_PUBLIC_BASE_DIRECTORY', public_path());

  use OSC\Core\DateTime;

  class OSCOM {
    const TIMESTAMP_START = LARAVEL_START;
    ...
    public static function siteExists($site) {
      return class_exists('OSC\\Core\\Site\\' . $site . '\\Controller');
    }
    ...
    public static function siteApplicationExists($application) {
      return class_exists('OSC\\Core\\Site\\' . static::getSite() . '\\Application\\' . $application . '\\Controller');
    }
    ...
    public static function getDefaultSiteApplication() {
      return call_user_func(array('OSC\\Core\\Site\\' . static::getSite() . '\\Controller', 'getDefaultApplication'));
    }
    ...
    public static function callDB($procedure, $data = null, $type = 'Application') {
      ...
      switch ( $type ) {
        ...
        default:
          ...
          $ns = 'OSC\\Core\\Site\\' . $call[0] . '\\Application\\' . $call[1];
          $procedure = $call[2];
      }
