 ...
 */
  ...
  namespace OSC\Core\PDO\MySQL;

  use OSC\Core\OSCOM;

  class Standard extends \OSC\Core\PDO {
...
// Override ATTR_STATEMENT_CLASS to automatically handle foreign key constraints
      if ( $this->_has_native_fk === false ) {
        $this->_driver_options[\PDO::ATTR_STATEMENT_CLASS] = array('OSC\\Core\\PDO\\MySQL\\Standard\\PDOStatement', array($this));
      }
    }
